...
| `ultra` | Bare fragments. One word when one word is enough. No invented abbreviations, no arrows. |
...
- [`.claude/rules/writing-skills.md`](../../rules/writing-skills.md): como os agents e comandos deste repo
  são obrigados a usar `caveman` (conversa) e `humanizer` (arquivos)
