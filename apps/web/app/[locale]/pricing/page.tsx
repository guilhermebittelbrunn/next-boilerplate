...
import { getDictionaryFromRequest, getLocale } from "@repo/internationalization";
          ...
          <div className="flex flex-col gap-2 px-3 py-1 md:px-6 md:py-4">
            ...
            <Button asChild className="mt-8 gap-4" variant="outline">
              <Link href={`/${locale}/contact`}>
                {dictionary.global.primaryCta} <PhoneCall className="h-4 w-4" />
              </Link>
            </Button>
          </div>
